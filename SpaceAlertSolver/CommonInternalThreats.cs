...
{
    public SaboteurRed(IGame game, Trajectory traj) : base(game,traj,time)
    {
        health = 1;
...
{
    public SaboteurBlue(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 1;
        position = Position.BottomMiddle;
        speed = 4;
...
{
    public SkirmisherRed(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 1;
...
{
    public SkirmisherBlue(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 1;
...
{
    public SoldiersRed(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 2;
        position = Position.TopLeft;
        speed = 2;
...
{
    public SoldiersBlue(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 2;
...
{
    public Virus(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 3;
...
{
    public HackedShieldsRed(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 3;
        position = Position.TopLeft;
        game.ship.BDefect[0]++;
...
{
    public HackedShieldsBlue(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 3;
        position = Position.TopRight;
        game.ship.BDefect[2]++;
...
{
    public OverheatedReactor(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 3;
        position = Position.BottomMiddle;
        game.ship.BDefect[4]++;
...
{
    public UnstableWarheads(IGame game, Trajectory traj) : base(game, traj)
    {
...
class SlimeBlue : InThreat
{
    bool[] positions;
    int[] healths;
    public SlimeBlue(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 2;
        speed = 2;
        scoreLose = 3;
...
class SlimeRed : InThreat
{
    bool[] positions;
    int[] healths;
    public SlimeRed(IGame game, Trajectory traj) : base(game, traj)
    {
        health = 2;
        speed = 2;
        scoreLose = 3;
