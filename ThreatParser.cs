...
namespace SpaceAlertSolver
{
    static class ThreatParser
    {
        ...
        static ThreatName[] in_threats = new ThreatName[]
        {
            ...
            new ThreatName("Red Commandos", false, 11),
            new ThreatName("Blue Commandos", false, 12),
            new ThreatName("Alien", false, 13),
            new ThreatName("Eliminator", false, 14),
            new ThreatName("Seeker", false, 15),
            new ThreatName("Atomic Bomb", false, 16),
            new ThreatName("Rebellious Robots", false, 17),
